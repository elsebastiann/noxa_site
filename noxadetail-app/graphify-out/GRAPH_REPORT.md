...
## Corpus Check
- 66 files · ~235,568 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3616 nodes · 6904 edges · 243 communities (195 shown, 48 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 108 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21fe840d`
...
## Communities (243 total, 48 thin omitted)
...
Cohesion: 0.06
Nodes (24): login_as(), parametrize, Es plata que sale: no es pantalla de consulta general., admin(), _limpiar(), fixture, Registrar un parqueadero crea una venta SIN cita asociada. Ese es el punto:…, Preguntarle a la data da acceso a toda la plata de una forma que ningún tablero… (+16 more)
...
Cohesion: 0.05
Nodes (54): _almacen_borrar(), _almacen_entregar(), _almacen_guardar(), _aplicar_datos_recepcion(), _aplicar_retencion(), backup_download(), _backups_existentes(), backups_list() (+46 more)
...
Cohesion: 0.07
Nodes (29): appointments_list(), calendar_diagnosticos(), calendar_view(), logout(), notifications_list(), parking_delete(), parking_list(), payment_methods_list() (+21 more)
...
### Community 39 - "Appointment Form (Shared Partial)"
Cohesion: 0.06
Nodes (39): Agreement, agreements_create_alias(), agreements_quick_create(), agrupar_servicios(), api_estimate_price(), api_public_mb_price(), apply_adjustments(), apply_agreement_discount() (+31 more)
...
### Community 43 - "_conv"
Cohesion: 0.07
Nodes (28): _cita(), _columna(), _conv(), _limpio(), _msg(), fixture, Tablero de seguimiento: leads y clientes pendientes de contactar. Existe porque…, Cadencia del negocio: lavada premium cada 3-4 semanas. (+20 more)

### Community 44 - "make_user"
Cohesion: 0.07
Nodes (13): make_user(), TestApiDiaCerrado, Un precio con duración 0 hace que la cita no ocupe tiempo en el calendario, y…, Es la razón de que exista el endpoint aparte: /update exige un ServicePrice que…, TestEdicionDeCelda, TestInTrial, Dos filas para la misma tarjeta se contradirían entre sí., Guardar la decisión humana en `status` la borraría Mariana en el siguiente… (+5 more)
...
Cohesion: 0.09
Nodes (18): ClientPlan, delete_appointment(), liberar_plan_de_cita(), Un plan vendido, atado a una placa. El saldo se guarda en columnas y no se…, Al cancelar o desmarcar una cita el cupo vuelve al cliente. Se topea contra lo…, Devuelve el cupo cuando la cita se cancela o se borra., Borrar una cita es irreversible y se pierde el historial del cliente, así que…, Appointments List (DataTable) (+10 more)

### Community 55 - "cuando"
Cohesion: 0.13
Nodes (12): cuando(), parametrize, A un lead callado se le escribe dos veces. No más. 1) Al día siguiente a las…, El job corre cada media hora. Con el tope en las 18:00 en punto, un objetivo…, Escriba a la hora que escriba, el mensaje sale entre las 9 y las 17:30. Es lo…, El caso normal, y el que justifica toda la regla: dentro de la ventana de 24h…, El costo conocido de respetar la franja: a estas horas las 23 horas caen antes…, Quien escribe a las 00:30 tiene sus 23 horas a las 23:30 del mismo día — muy… (+4 more)
...
Cohesion: 0.13
Nodes (21): avisar_admin_whatsapp(), _job_admin_reminder(), _job_post_service_followup(), notify_admin_bot_booking(), notify_admin_bot_reschedule(), notify_admin_gestion_cliente(), notify_admin_mercedes_benz_booking(), Devuelve (numero_sin_prefijo, error). El sender de producción de NOXA es el… (+13 more)
...
Cohesion: 0.29
Nodes (7): _guardar_foto_vehiculo(), _nuevo_codigo_solicitud(), price_request_new(), PriceRequestPhoto, Guarda la foto y devuelve el nombre con el que quedó, o None. Nombre aleatorio:…, Mismo alfabeto sin letras confundibles que los códigos de cotización, con otro…, Una foto más del vehículo, además de la principal. Un carro no se cotiza con…
...
### Community 87 - "_servicios_facturables"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (26): Appointment, AppointmentOperator, calculate_real_duration_minutes(), edit_appointment(), _guardar_tercerizacion(), _int_o_cero(), _leer_entrega_programada(), _minutos_extra_tercerizacion() (+18 more)

### Community 98 - "Quote"
Cohesion: 0.12
Nodes (6): Quote, Si el cliente miró esto, cuándo y cuántas veces. Una cotización sin respuesta y…, La URL que se le manda al cliente. None si todavía no tiene token. Prefiere…, [(marca, garantía), ...] como estaban al emitir la cotización. Se filtran las…, {marca: [coberturas que esa marca no ofrece]}. Hay que decirlo en el documento.…, Una cotización que se le entrega al cliente y se puede volver a consultar. Todo…
...
### Community 104 - "payroll_detail.html"
Cohesion: 0.11
...
### Community 115 - "book_diagnostic_from_bot"
Cohesion: 0.14
Nodes (16): api_dia_cerrado(), book_diagnostic_from_bot(), _diagnostic_service(), es_festivo(), _find_active_appointment_by_plate(), motivo_dia_cerrado(), Nombre del festivo si esa fecha lo es, o None., Servicio con el que se agendan los diagnósticos. Se busca por nombre… (+8 more)
...
### Community 119 - "test_festivos.py"
Cohesion: 0.20
Nodes (9): festivo_en_la_ventana(), _proximo(), proximo_domingo(), proximo_habil(), NOXA no atiende domingos ni festivos colombianos. Los festivos no se pueden…, Marca como festivo un día hábil próximo, inyectándolo en el caché. El…, El bloqueo vive en get_available_slots(), no en cada llamador., Primera fecha FUTURA que cumple `pred`. Los tests que pasan por la ventana de… (+1 more)
...
### Community 121 - "route"
Cohesion: 0.06
Nodes (36): api_client_by_name(), api_client_by_phone(), api_client_by_plate(), api_public_stats_appointments_count(), expense_categories_rename(), index(), installer_toggle(), payment_methods_new() (+28 more)

### Community 122 - "quote_edit"
Cohesion: 0.23
Nodes (12): _catalogo_para_cotizar(), _catalogo_polarizado(), _catalogo_ppf(), _catalogo_wrap(), _partes_ppf(), quote_edit(), quote_new(), {vehicle_type_id: [{id, nombre, categoria, precio}, ...]} Se manda entero al… (+4 more)

### Community 123 - "_can_see_notifications"
Cohesion: 0.20
Nodes (10): _can_see_notifications(), notification_mark_read(), notifications_mark_all_read(), promo_image(), promotions_delete(), promotions_toggle(), Sirve una foto que mandó un cliente. A diferencia de las promociones, esto SÍ…, Sirve la imagen de una promoción. Es pública a propósito: Twilio la descarga… (+2 more)
...
Cohesion: 0.18
Nodes (7): _limpiar_seleccion(), QuoteVersion, Lo que el cliente armó por su cuenta desde el link. NO toca la cotización…, NULL quiere decir "versión de antes del wrap", no "las quitó todas": ahí se…, Deja solo lo que de verdad pertenece a esta cotización. Los ids llegan del…, Una versión que sirve para imprimir pero no se guarda. Para cuando quien está…, _version_en_memoria()
...
### Community 127 - "service_prices.html"
Cohesion: 0.18
Nodes (8): Crea o actualiza el precio de una celda de la matriz. Hace falta aparte de…, run_migrate_prices(), service_prices_cell(), service_prices_new(), service_prices_toggle(), service_prices_update(), ServicePrice, vehicle_types_toggle()

### Community 128 - "limit"
Cohesion: 0.07
Nodes (31): api_client_names(), api_client_plates(), _ficha_por_token(), _guardar_version_cliente(), price_request_public(), quote_public(), quote_public_pdf(), quote_public_seleccion() (+23 more)
...
### Community 130 - "template_global"
Cohesion: 0.22
Nodes (10): appointment_json(), es_marketing(), es_operario(), puede_editar_cotizaciones(), puede_ver_precios(), puede_ver_seguimiento(), Quién ve cuánto vale un servicio. El operario agenda y trabaja citas, pero no…, Quién puede CREAR o cambiar una cotización, no solo verla. Marketing entra a… (+2 more)

### Community 131 - "_preguntar_a_los_datos"
Cohesion: 0.07
...
### Community 132 - "_construir_pdf_recibo"
Cohesion: 0.22
Nodes (10): appointment_receipt(), _construir_pdf_recibo(), _cop(), _marca_de_agua_noxa(), numero_de_recibo(), 120000 -> "$120.000". El separador de miles en Colombia es el punto., El logo con el canal alfa rebajado, para usarlo como marca de agua. reportlab…, El número que lleva impreso el recibo. Sale del id de la cita y no de un… (+2 more)
...
Cohesion: 0.06
Nodes (18): _base_publica(), _generar_miniatura(), hora_bogota_naive(), _nombre_miniatura(), PriceRequest, Versión liviana de la foto, para la vista previa de WhatsApp. WhatsApp descarga…, El mismo instante, expresado en hora de Bogotá y sin zona. Para lo que se lee…, De dónde cuelgan los links que salen de la app hacia afuera. (+10 more)

### Community 136 - "api_events"
Cohesion: 0.08
...
### Community 138 - "puede_ver_finanzas"
Cohesion: 0.22
Nodes (8): AppointmentOutsourcing, plans_list(), puede_ver_finanzas(), Marketing ve conversión y comportamiento de clientes, no la caja., Planes vendidos, con su saldo. Lo primero que se necesita saber es a quién le…, El reparto de UN servicio tercerizado dentro de una cita. Va por servicio y no…, Pasada única sobre el histórico: aplicarle el reparto a las citas de…, reclasificar_tercerizacion()

### Community 139 - "User"
Cohesion: 0.17
Nodes (10): change_password(), _is_safe_redirect_target(), login(), Evita "open redirect": el 'next' debe ser una ruta propia (/algo), nunca una…, True si el empleado aún está en período de prueba (primer mes desde hire_date)., seed_demo_data(), seed_superadmin(), User (+2 more)

### Community 140 - "puede_cotizar"
Cohesion: 0.22
Nodes (9): price_request_delete(), price_request_detail(), price_requests_list(), puede_cotizar(), quote_delete(), quote_detail(), Quién entra a las cotizaciones. El operario no: agenda y trabaja citas, pero no…, Borrar una cotización es irreversible: se va el documento que el cliente tiene… (+1 more)
...
### Community 144 - "bogota_today"
Cohesion: 0.10
Nodes (26): api_public_mb_availability(), api_public_mb_available_days(), api_public_mb_book(), _appointment_capacity_profile(), bogota_today(), calculate_estimated_amount_for_appointment(), corte_instalador_pagar(), _day_business_end() (+18 more)

### Community 145 - "whatsapp.html"
Cohesion: 0.08
Nodes (25): api_notifications(), api_preguntar(), _estados_entrega(), _filtro_hace_cuanto(), _filtro_hora_bogota(), _filtro_sin_tildes(), preguntar_view(), puede_preguntar_a_los_datos() (+17 more)

### Community 146 - "test_agendar_repetido.py"
Cohesion: 0.25
Nodes (8): conv(), placa(), fixture, Repetir [AGENDAR:] con los mismos datos no es un error: la cita ya está. Caso…, Placa única por test: el guardia busca por placa, así que reusarla entre tests…, fixture, La BD semilla no trae servicio de diagnóstico, así que se crea uno. Sin esto…, servicio_diagnostico()

### Community 147 - "ppf_totales_de"
Cohesion: 0.25
...
### Community 148 - "date"
Cohesion: 0.08
Nodes (36): analytics_dashboard(), analytics_detalle(), appointment_money(), bogota_now(), _citas_sin_reclasificar(), dashboard_gerencial(), _filtro_dia_bogota(), _job_ceramic_3weeks() (+28 more)
...
### Community 151 - "festivos_colombia"
Cohesion: 0.25
...
Cohesion: 0.15
Nodes (14): corte_instalador_borrar(), corte_instalador_detalle(), corte_instalador_nuevo(), cortes_instaladores_view(), _lineas_ya_cortadas(), _motivo_del_descuento(), Por qué esta cita se cobró por debajo de lista. Sin esto el corte muestra un…, Los trabajos que ya entraron a un corte. Son los que no pueden volver a entrar:… (+6 more)
...
### Community 163 - "quote_duplicate"
Cohesion: 0.25
Nodes (6): _nuevo_codigo_cotizacion(), quote_duplicate(), QuoteItem, Una línea de la cotización. `service_id` es opcional a propósito: además del…, Código corto, aleatorio y único. Aleatorio y no consecutivo por pedido…, Copia una cotización a un código nuevo, para usarla de base. Copia los precios…
...
### Community 165 - "TestBloqueoAlAgendarDesdeElBot"
Cohesion: 0.39
...
### Community 168 - "ppf_prices_list"
Cohesion: 0.29
Nodes (7): delete_service(), ppf_prices_list(), puede_borrar_servicios(), El catálogo de wrap: una cobertura, un precio. Mucho más simple que la de PPF…, Grupos de PPF: qué partes trae cada uno, su precio por marca y el adicional de…, Elimina un servicio y su lista de precios. Tres candados, en orden de qué tan…, wrap_prices_list()
...
### Community 170 - "excluido_de_convenio"
Cohesion: 0.29
Nodes (7): excluido_de_convenio(), Si este servicio tiene su propia sección en la cotización., Si este servicio se cobra a precio completo pese al convenio., Devuelve (precio_con_descuento, precio_sin_descuento)., se_cotiza_aparte(), _sin_tildes(), split_price_by_agreement_eligibility()

### Community 171 - "push_notification"
Cohesion: 0.29
Nodes (6): Notification, notify_admin_escalation(), push_notification(), Avisa al admin por WhatsApp cuando Mariana detecta una señal de negocio que…, Alertas internas del panel — la campanita. Existe porque avisarle al admin por…, Registra una alerta en la campanita. Nunca lanza: una notificación que falla no…
...
### Community 174 - "Agreements (Convenios) Management Page"
Cohesion: 0.33
...
Cohesion: 0.16
Nodes (16): _clean_phone_or_default(), _gestiones_activas(), _historial_ceramico(), _normalize_whatsapp_number(), Normaliza un número al formato E.164 que usa Twilio/WhatsApp (+57 por defecto,…, Devuelve el celular normalizado solo si parece un teléfono de verdad.…, El tablero de pipeline: leads y clientes que necesitan que alguien los contacte…, Devuelve (ocultas, escritas). Están separadas porque escribirle a alguien NO… (+8 more)

### Community 176 - "dia_bogota"
Cohesion: 0.33
Nodes (6): api_price_requests_respondidas(), dia_bogota(), _dia_bogota_iso(), El día en Bogotá, en ISO, para el filtro de fechas de la bandeja. Va en ISO y…, Las solicitudes ya contestadas, para traerlas a una cotización. Solo las…, El día calendario en Bogotá de un timestamp guardado en UTC. `created_at` y…

### Community 178 - "VehicleType"
Cohesion: 0.33
Nodes (4): seed_vehicle_types(), vehicle_types_new(), VehicleType, Migración de precios según Catálogo NOXA. Ejecutar una vez en el próximo…

### Community 179 - "TestNoHayUnTercero"
Cohesion: 0.33
Nodes (3): Eran cuatro. Si alguien agrega una tercera sin querer, el lead vuelve a recibir…, La otra mitad de la regla: no basta con que no haya tercera etapa, el lead…, TestNoHayUnTercero

### Community 181 - "expense_categories_new"
Cohesion: 0.40
...
Cohesion: 0.15
Nodes (12): installer_edit(), installers_view(), _marcas_del_armador(), ppf_marcas_activas(), PpfPrice, Las marcas que el armador debe mostrar: las del catálogo y, al editar, también…, [(nombre, garantía), ...] en el orden en que se muestran. Devuelve tuplas y no…, Precios de PPF, que no caben en `service_prices`. El eje de un PPF no es el… (+4 more)

### Community 188 - "_leer_formulario_de_cotizacion"
Cohesion: 0.25
Nodes (6): _leer_formulario_de_cotizacion(), QuoteTintItem, QuoteWrapItem, Una línea de polarizado OFRECIDA en una cotización, con todo congelado. Se…, Una cobertura de wrap dentro de una cotización, con su precio congelado. Va…, Vuelca el formulario sobre `cot`. Devuelve el error, o None si quedó bien.…
...
### Community 193 - "PARTE 2 — Análisis del documento "Plantillas WP NOXA""
Cohesion: 0.40
...
### Community 194 - "TestVentasSinCita"
Cohesion: 0.40
...
Cohesion: 0.25
Nodes (8): _construir_pdf_cotizacion(), garantia_texto(), _ppf_no_cubre_en(), quote_pdf(), El PDF que se le entrega al cliente. Con `version`, imprime la combinación que…, 1 año" / "5 años" / "" — el singular importa: "1 años" se ve descuidado justo…, {marca: [coberturas que no ofrece]}, sobre la lista dada., texto_garantia()

### Community 196 - "api_plans_by_plate"
Cohesion: 0.50
...
### Community 198 - "ensure_whatsapp_canal_schema"
Cohesion: 0.50
...
### Community 205 - "_tpl_reactivacion_para"
Cohesion: 0.50
...
### Community 206 - "_depurar_fotos_vencidas"
Cohesion: 0.67
Nodes (3): _depurar_fotos_vencidas(), _job_depurar_fotos_recepciones(), Borra las fotos de las fichas entregadas hace más de 90 días. Solo las fotos:…

### Community 207 - "_reparar_service_sales_appointment_id"
Cohesion: 0.67
...
### Community 209 - "public_booking_mercedes"
Cohesion: 0.67
...
- **Why does `make_user()` connect `make_user` to `TestDesdeDondeSeSaca`, `make_admin`, `test_abonos_ajustes.py`, `_admin`, `TestFormulario`, `test_archivar_conversaciones.py`, `User`, `test_backfill_calificacion.py`, `test_lista_precios.py`, `test_editar_conserva.py`, `foto`, `test_avisos_admin_plantilla.py`, `login_as`, `_borrar`, `_borrar`, `_lecturas`, `test_saldos.py`, `TestSeCreaSolo`, `TestAgendaDeDiagnosticos`, `test_marcas_sin_precio.py`, `TestPermisos`, `_abrir`, `test_recibo_cita.py`, `test_filtro_fechas_whatsapp.py`, `test_servicios_ui.py`, `_conv`, `TestUnaMarcaEscritaAMano`, `precio`, `test_descuento_en_pdf.py`, `datetime`, `test_ajuste_precios.py`, `test_duplicar_cotizacion.py`, `TestPanelManual`, `._login_admin`, `TestTiempoAdicional`, `test_cotizacion_autorrelleno.py`, `test_aviso_referencia.py`, `test_nav_movil.py`, `test_zona_horaria.py`, `test_agenda_cajon.py`, `test_cotizacion_publica.py`, `test_preguntar_datos.py`, `TestEditarUnInstalador`, `_borrar`, `test_solicitud_precios.py`, `_cita`, `test_cotizaciones.py`, `._login`, `_ficha_sellada`, `_borrar`, `TestTraerLosPreciosAUnaCotizacion`, `test_colores_agenda.py`, `TestVistaPreviaDelPrecio`, `test_marcas_ppf.py`, `_borrar`, `test_festivos.py`, `test_recepcion_carros.py`?**
  _High betweenness centrality (0.400) - this node is a cross-community bridge._
- **Why does `login_as()` connect `login_as` to `TestDesdeDondeSeSaca`, `make_admin`, `test_abonos_ajustes.py`, `_admin`, `TestFormulario`, `test_archivar_conversaciones.py`, `test_backfill_calificacion.py`, `test_lista_precios.py`, `test_saldos.py`, `test_recibo_cita.py`, `TestAgendaDeDiagnosticos`, `TestPermisos`, `_abrir`, `test_filtro_fechas_whatsapp.py`, `test_servicios_ui.py`, `_conv`, `make_user`, `datetime`, `TestPanelManual`, `TestTiempoAdicional`, `test_agenda_cajon.py`, `test_preguntar_datos.py`, `_cita`, `_ficha_sellada`, `test_colores_agenda.py`, `TestVistaPreviaDelPrecio`, `test_festivos.py`, `test_recepcion_carros.py`?**
