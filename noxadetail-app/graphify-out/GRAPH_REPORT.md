...
## Corpus Check
- 55 files · ~192,712 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2742 nodes · 5144 edges · 195 communities (158 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 107 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d100a47f`
...
Cohesion: 0.09
Nodes (11): make_user(), TestInTrial, Preguntarle a la data da acceso a toda la plata de una forma que ningún tablero…, Un admin pasa el allowlist global, así que llega hasta la ruta y es MI candado…, Queda fuera antes de llegar a la ruta: dos capas, y la de afuera actúa primero…, TestQuienPuedeEntrar, Los saldos son información de la cuenta, no de la operación diaria., TestPaginaEstado (+3 more)

### Community 20 - "login_as"
Cohesion: 0.09
Nodes (14): login_as(), El formulario manda listas paralelas; acá se prueba el parseo., El default acordado con la operación: si nadie elige, es sobre lista., TestFormulario, TestApiDiaCerrado, Un precio con duración 0 hace que la cita no ocupe tiempo en el calendario, y…, Es la razón de que exista el endpoint aparte: /update exige un ServicePrice que…, TestEdicionDeCelda (+6 more)
...
### Community 22 - "_crear"
Cohesion: 0.08
Nodes (22): _crear(), _grupo(), instalador(), fixture, Pedirle precios a un instalador antes de cotizarle al cliente. Para cotizar un…, Se COPIA lo que incluye, no se referencia: la solicitud queda abierta cinco…, El nombre viaja por el formulario. Sin validarlo contra el catálogo, cualquiera…, Pedirle una cuenta a un proveedor externo por una lista de precios garantiza… (+14 more)
...
Cohesion: 0.07
Nodes (31): Expense, expense_categories_delete(), expense_categories_list(), expense_categories_new(), expense_categories_toggle(), ExpenseCategory, expenses_edit(), expenses_export() (+23 more)

### Community 29 - "date"
Cohesion: 0.09
Nodes (34): analytics_dashboard(), analytics_detalle(), appointment_money(), bogota_now(), dashboard_gerencial(), _filtro_dia_bogota(), _job_ceramic_3weeks(), _job_ceramic_followup() (+26 more)

### Community 30 - "route"
Cohesion: 0.06
Nodes (31): api_client_by_name(), api_client_by_phone(), api_client_by_plate(), api_public_stats_appointments_count(), expense_categories_rename(), installer_toggle(), payment_methods_toggle(), payroll_pay() (+23 more)
...
Cohesion: 0.05
Nodes (46): _catalogo_para_cotizar(), _catalogo_ppf(), categoria_de_servicio(), dia_bogota(), _guardar_foto_vehiculo(), installer_brands(), installers_view(), _leer_formulario_de_cotizacion() (+38 more)
...
Cohesion: 0.20
Nodes (13): api_public_mb_availability(), api_public_mb_available_days(), api_public_mb_book(), bogota_today(), calculate_estimated_amount_for_appointment(), _job_client_reminder(), Corre diariamente a las 7 PM (Bogotá). Notifica a clientes con cita mañana., El día de HOY en Colombia. Va en vez de `date.today()`, que en el servidor da… (+5 more)
...
Cohesion: 0.12
Nodes (18): api_dia_cerrado(), book_diagnostic_from_bot(), _diagnostic_service(), es_festivo(), _find_active_appointment_by_plate(), _job_post_service_followup(), motivo_dia_cerrado(), Servicio con el que se agendan los diagnósticos. Se busca por nombre… (+10 more)
...
Cohesion: 0.29
Nodes (7): api_preguntar(), Message, _quien(), Saca una conversación de la bandeja, con el motivo escrito. La nota se exige…, Un mensaje individual, entrante o saliente, de una conversación., whatsapp_archive(), whatsapp_send_manual()

### Community 72 - "whatsapp.html"
Cohesion: 0.12
Nodes (18): _dia_bogota_iso(), _estados_entrega(), _filtro_hace_cuanto(), _filtro_hora_bogota(), _filtro_sin_tildes(), El día en Bogotá, en ISO, para el filtro de fechas de la bandeja. Va en ISO y…, Orden cronológico, más reciente primero — el orden por defecto de cualquier…, {texto del mensaje: estado de entrega} para una conversación. Message y… (+10 more)

### Community 73 - "api_public_web_lead"
Cohesion: 0.31
...
### Community 113 - "limit"
Cohesion: 0.12
Nodes (17): api_client_names(), api_client_plates(), api_notifications(), _guardar_version_cliente(), price_request_public(), quote_public(), quote_public_pdf(), quote_public_seleccion() (+9 more)
...
### Community 117 - "push_notification"
Cohesion: 0.22
...
### Community 119 - "_build_message_history"
Cohesion: 0.25
...
### Community 123 - "_normalize_whatsapp_number"
Cohesion: 0.25
...
### Community 126 - "api_estimate_price"
Cohesion: 0.09
Nodes (26): Agreement, agreements_create_alias(), agreements_quick_create(), api_estimate_price(), api_public_mb_price(), apply_adjustments(), apply_agreement_discount(), apply_agreement_discount_split() (+18 more)

### Community 127 - "festivos_colombia"
Cohesion: 0.25
...
### Community 129 - "_generate_and_send_reply"
Cohesion: 0.25
Nodes (8): _generate_and_send_reply(), _looks_like_welcome_menu(), notify_admin_bot_booking(), _parse_agendar_marker(), ¿Este mensaje es el modelo reescribiendo el menú de bienvenida? No se compara…, nombre=X; celular=Y; ..." -> dict. Tolerante con el orden y los espacios., Avisa al admin cuando Mariana deja un diagnóstico agendado sola., Genera la respuesta con Claude y manda todos los mensajes. Devuelve False si…

### Community 130 - "whatsapp_webhook"
Cohesion: 0.25
...
Cohesion: 0.05
Nodes (41): abreviar_servicio(), abreviar_servicios(), agrupar_servicios(), api_events(), appointment_json(), calendar_view(), delete_service(), es_cita_de_diagnostico() (+33 more)

### Community 133 - "_kpis_embudo"
Cohesion: 0.29
...
Cohesion: 0.21
Nodes (8): payroll_entry_update(), payroll_vale_new(), Vale de adelanto de un operario., users_edit(), Vale, vales_new(), Bono 'Quincena perfecta' (sin errores de calidad), Política de período de prueba: 30 días, -$100.000 salario, sin bonos
...
### Community 137 - "TestBloqueoAlAgendarDesdeElBot"
Cohesion: 0.39
...
### Community 138 - "_job_check_saldos"
Cohesion: 0.29
Nodes (7): _diagnostico_anthropic(), _get_claude_client(), _job_check_saldos(), Devuelve (saldo, moneda, error). `saldo=None` significa que no se pudo leer., Prueba la API de Claude con la petición más barata posible. Devuelve (ok,…, Corre diariamente a las 8 AM (Bogotá). Avisa ANTES de que se acabe, no después:…, _saldo_twilio()

### Community 139 - "payroll_new"
Cohesion: 0.29
...
### Community 143 - "Agreements (Convenios) Management Page"
Cohesion: 0.33
...
### Community 146 - "generate_followup_message"
Cohesion: 0.33
Nodes (6): _cliente_pidio_esperar(), _fecha_hoy_para_prompt(), generate_followup_message(), Qué día es hoy, en hora de Bogotá y en español. El modelo no tiene reloj: si no…, Genera un mensaje de seguimiento personalizado para un lead que quedó en…, ¿El cliente dijo explícitamente que después, en vez de quedarse callado? Sin…

### Community 147 - "test_agendar_repetido.py"
Cohesion: 0.40
...
### Community 149 - "AppointmentAdjustment"
Cohesion: 0.40
...
### Community 152 - "excluido_de_convenio"
Cohesion: 0.40
...
### Community 156 - "Mariana — base de conocimiento actual, análisis del documento de plantillas y plan"
Cohesion: 0.40
...
### Community 157 - "PARTE 2 — Análisis del documento "Plantillas WP NOXA""
Cohesion: 0.40
...
### Community 158 - "PARTE 3 — Plan: que Mariana agende diagnósticos de verdad"
Cohesion: 0.40
...
### Community 160 - "test_parqueadero.py"
Cohesion: 0.50
Nodes (4): admin(), _limpiar(), fixture, Registrar un parqueadero crea una venta SIN cita asociada. Ese es el punto:…

### Community 161 - "_costo_railway"
Cohesion: 0.50
Nodes (4): _costo_railway(), _fecha_iso(), Consulta el gasto de la cuenta de Railway. Devuelve (datos, error). El dinero…, Las fechas de Railway llegan en ISO 8601 con zona; acá solo importa el día.

### Community 162 - "ensure_whatsapp_canal_schema"
Cohesion: 0.50
...
### Community 163 - "_format_availability_for_prompt"
Cohesion: 0.50
...
### Community 167 - "_tpl_reactivacion_para"
Cohesion: 0.50
...
### Community 168 - "_reparar_service_sales_appointment_id"
Cohesion: 0.67
...
- **Why does `make_user()` connect `make_user` to `make_admin`, `test_abonos_ajustes.py`, `test_archivar_conversaciones.py`, `test_backfill_calificacion.py`, `TestPanelManual`, `test_editar_conserva.py`, `foto`, `login_as`, `_crear`, `_borrar`, `TestSeCreaSolo`, `test_marcas_ppf.py`, `._login_admin`, `test_parqueadero.py`, `test_saldos.py`, `test_filtro_fechas_whatsapp.py`, `test_servicios_ui.py`, `test_festivos.py`, `_conv`, `User`, `TestLaPantallaDePrecios`, `precio`, `test_descuento_en_pdf.py`, `datetime`, `test_zona_horaria.py`, `test_duplicar_cotizacion.py`, `TestTiempoAdicional`, `test_cotizacion_autorrelleno.py`, `test_aviso_referencia.py`, `TestAgendaDeDiagnosticos`, `test_nav_movil.py`, `test_cotizacion_publica.py`, `test_preguntar_datos.py`, `._login_admin`, `_borrar`, `.test_sin_porcentaje_valido_cae_al_del_catalogo`, `test_lista_precios.py`, `_cita`, `test_cotizaciones.py`, `._login`, `TestEliminar`, `conftest.py`, `test_colores_agenda.py`, `TestLaLogicaDelRango`?**
  _High betweenness centrality (0.355) - this node is a cross-community bridge._
- **Why does `login_as()` connect `login_as` to `make_admin`, `test_abonos_ajustes.py`, `test_archivar_conversaciones.py`, `test_backfill_calificacion.py`, `TestPanelManual`, `make_user`, `test_parqueadero.py`, `test_saldos.py`, `test_filtro_fechas_whatsapp.py`, `test_servicios_ui.py`, `test_festivos.py`, `_conv`, `datetime`, `TestTiempoAdicional`, `TestAgendaDeDiagnosticos`, `test_preguntar_datos.py`, `.test_sin_porcentaje_valido_cae_al_del_catalogo`, `test_lista_precios.py`, `_cita`, `conftest.py`, `test_colores_agenda.py`, `TestLaLogicaDelRango`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `precio()` connect `precio` to `._login_admin`, `test_cotizacion_publica.py`, `TestElLinkYElPdfDicenLoMismo`, `TestDosPartes`, `TestLaMigracionDeNombres`, `._login_admin`, `foto`, `test_descuento_en_pdf.py`, `TestPreciosPpf`, `_borrar`, `_borrar`, `test_marcas_ppf.py`, `test_cotizaciones.py`?**
