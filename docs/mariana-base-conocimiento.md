...
| Menú numerado (C1) | **No se implementa.** Mariana mantiene su saludo conversacional; las 4 puertas del menú quedan como lógica de ruteo (sección `POR DÓNDE ARRANCA EL CLIENTE`), no como lista que ve el cliente. |
